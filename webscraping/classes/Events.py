...
from classes.Event import (OwnGoal, PenaltyGoal, PlayGoal, RedCard, Substitute,
                   YellowCard)
...
class Events():
    ...
    def _analyse(self, text):
        ...
        match type:
            case "Spillemål": type = PlayGoal(self.game, minute, team, (name, url))
            case "Straffemål": type = PenaltyGoal(self.game, minute, team, (name, url))
            case "Selvmål": type = OwnGoal(self.game, minute, team, (name, url))
            case "Advarsel": type = YellowCard(self.game, minute, team, (name, url))
            case "Utvisning": type = RedCard(self.game, minute, team, (name, url))
            case "Bytte inn": type = Substitute(self.game, minute, team, name)
            case "Bytte ut": type = Substitute(self.game, minute, team, name)
